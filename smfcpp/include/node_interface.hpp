#ifndef SMFCPP__NODE_INTERFACE_HPP_
#define SMFCPP__NODE_INTERFACE_HPP_
...
public:
    ...
    explicit NodeTimer(smfcpp::node_interface::NodeBaseInterface::SharedPtr node_base);
    virtual
    ~NodeTimer() = default;
...
private:
    ...
    smfcpp::node_interface::NodeBaseInterface::SharedPtr o_node_base;
};


class NodeRecverInterface
{
public:
    SMFCPP_SMART_PTR_ALIASES_ONLY(NodeRecverInterface)

    virtual
    ~NodeRecverInterface() = default;
...
class NodeRecver: public NodeRecverInterface
{
public:
    SMFCPP_SMART_PTR_ALIASES_ONLY(NodeRecver)
...
private:
    SMFCPP_DISABLE_COPY(NodeRecver)
    smfcpp::node_interface::NodeBaseInterface::SharedPtr o_node_base;
};
